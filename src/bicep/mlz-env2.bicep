...
param environmentAbbreviation string = 't'
...
param firewallClientSubnetAddressPrefix string = '10.50.1.0/26'
...
param firewallManagementSubnetAddressPrefix string = '10.50.1.64/26'

@description('The CIDR Virtual Network Address Prefix for the Identity Virtual Network.')
param identityVirtualNetworkAddressPrefix string = '10.50.10.0/23'
...
param identitySubnetAddressPrefix string = '10.50.10.0/24'

@description('The CIDR Virtual Network Address Prefix for the Operations Virtual Network.')
param operationsVirtualNetworkAddressPrefix string = '10.50.6.0/23'
...
param operationsSubnetAddressPrefix string = '10.50.6.0/24'

@description('The CIDR Virtual Network Address Prefix for the Shared Services Virtual Network.')
param sharedServicesVirtualNetworkAddressPrefix string = '10.50.14.0/23'
...
param sharedServicesSubnetAddressPrefix string = '10.50.14.0/24'
...
param firewallSupernetIPAddress string = '10.50.0.0/20'
...
param bastionHostSubnetAddressPrefix string = '10.50.0.0/24'
...
param azureGatewaySubnetAddressPrefix string = '10.50.1.128/26'
